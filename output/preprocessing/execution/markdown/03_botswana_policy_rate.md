...
- Dataset: 03_botswana_policy_rate
...
| --- | --- | --- | --- | --- |
| P001 | Convert the Date column to datetime using the specified parsing policy. | SUCCESS | 0.001105s | PASS |
| P002 | Sort the time series chronologically using the JSON-specified sort settings. | SUCCESS | 0.000753s | PASS |
| P003 | Validate that Date remains datetime-typed after preprocessing. | SUCCESS | 0.000144s | PASS |
| P004 | Validate that the expected schema remains intact. | SUCCESS | 0.000074s | PASS |
| P005 | Validate that the output row count is preserved. | SUCCESS | 0.000065s | PASS |
| P006 | Validate that Date remains available for joins. | SUCCESS | 0.000048s | PASS |
...
- Processed filename: 03_botswana_policy_rate_processed.csv
